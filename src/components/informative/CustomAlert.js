...
//       case 'success':
//         return (
//           <Ionicons name="checkmark-circle" color="#4CAF50" {...iconProps} />
//         );
//       case 'error':
//         return <Ionicons name="close-circle" color="#F44336" {...iconProps} />;
//       case 'warning':
//         return <Ionicons name="warning" color="#FF9800" {...iconProps} />;
//       case 'confirm':
//         return <Ionicons name="help-circle" color="#2196F3" {...iconProps} />;
//       case 'info':
//       default:
//         return (
//           <Ionicons name="information-circle" color="#2196F3" {...iconProps} />
//         );
//     }
//   };
