...
//     const distance = 80; // How far finger moves
//     const duration = 1200; // Animation duration

//     switch (direction) {
//       case 'left': // Swipe LEFT (prev product)
...
//             }),
//             withTiming(-distance, { duration: 200 }), // Pause at end
//           ),
//           -1, // Infinite
//           false,
//         );
...
//       case 'right': // Swipe RIGHT (next product)
//         translateX.value = withRepeat(
//           withSequence(
//             withTiming(0, { duration: 0 }),
//             withTiming(distance, {
