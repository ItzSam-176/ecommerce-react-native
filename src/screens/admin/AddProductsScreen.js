...
//       // [Info]: Use public URL instead of signed URL
...
//             description,
//             image_url: imagePath?.publicUrl || product.image_url, // Changed from signedUrl
...
//           .from('products')
//           .update({
//             image_url: imagePath.publicUrl, // Changed from signedUrl
//             image_folder: folderName,
//           })
//           .eq('id', productId);
//       }
...
//         inside={dropdownInFocus ? true : false}
...
//             activeOpacity={0.7}
//           >
//             <Text style={styles.insideChipText}>{item.name}</Text>
...
//             {/* Selected Chips - Show inside dropdown */}
